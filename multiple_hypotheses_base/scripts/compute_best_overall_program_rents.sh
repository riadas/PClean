...
do 
    ...
    do
        ...
        do
            ...
            echo $counter 
            ((counter++))
            julia --project=$home_dir $home_dir/multiple_hypotheses_base/scripts/compute_best_overall_program_rents.jl $method $benchmark $filename > "${home_dir}/logs/${method}_${benchmark}_${counter}.txt" &
            sleep 10
        done
    done
    # sleep 32400
