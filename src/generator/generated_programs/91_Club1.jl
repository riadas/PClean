...
foreign_keys = ["club id", "student id"]
column_names_without_foreign_keys = Any[Any[-1, "*"], Any[0, "last name"], Any[0, "first name"], Any[0, "age"], Any[0, "sex"], Any[0, "major"], Any[0, "advisor"], Any[0, "city code"], Any[1, "club name"], Any[1, "club description"], Any[1, "club location"], Any[2, "position"]]
if length(omitted) == 0 
...
query = @query Club1Model.Obs [
    ...
    member_of_club_position position
]
