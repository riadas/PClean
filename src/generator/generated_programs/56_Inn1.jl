...
query = @query Inn1Model.Obs [
    ...
    reservations_code code
    reservations_check_in check_in
    reservations_check_out check_out
    reservations_rate rate
    reservations_last_name last_name
    reservations_first_name first_name
    reservations_adults adults
    reservations_kids kids
]
