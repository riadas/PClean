...
query = @query PerpetratorModel.Obs [
    ...
    perpetrator_date date
    perpetrator_year year
    perpetrator_location location
    perpetrator_country country
    perpetrator_killed killed
    perpetrator_injured injured
