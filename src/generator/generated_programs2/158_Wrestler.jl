...
## construct possibilities
cols = Any[Any[-1, "*"], Any[0, "wrestler id"], Any[0, "name"], Any[0, "reign"], Any[0, "days held"], Any[0, "location"], Any[0, "event"], Any[1, "elimination id"], Any[1, "wrestler id"], Any[1, "team"], Any[1, "eliminated by"], Any[1, "elimination move"], Any[1, "time"]]
...
query = @query WrestlerModel.Obs [
    wrestler_id elimination.wrestler.wrestler_id
    wrestler_name elimination.wrestler.name
    wrestler_reign elimination.wrestler.reign
    wrestler_days_held elimination.wrestler.days_held
    wrestler_location elimination.wrestler.location
    wrestler_event elimination.wrestler.event
