...
## construct possibilities
cols = Any[Any[-1, "*"], Any[0, "manufacturer id"], Any[0, "open year"], Any[0, "name"], Any[0, "num of factories"], Any[0, "num of shops"], Any[1, "furniture id"], Any[1, "name"], Any[1, "num of component"], Any[1, "market rate"], Any[2, "manufacturer id"], Any[2, "furniture id"], Any[2, "price in dollar"]]
foreign_keys = map(tup -> cols[tup[1] + 1], Any[Any[11, 6], Any[10, 1]])
...
query = @query ManufacturerModel.Obs [
    manufacturer_id furniture_manufacte.manufacturer.manufacturer_id
    manufacturer_open_year furniture_manufacte.manufacturer.open_year
    manufacturer_name furniture_manufacte.manufacturer.name
    manufacturer_num_of_factories furniture_manufacte.manufacturer.num_of_factories
    manufacturer_num_of_shops furniture_manufacte.manufacturer.num_of_shops
    furniture_id furniture_manufacte.furniture.furniture_id
    furniture_name furniture_manufacte.furniture.name
    furniture_num_of_component furniture_manufacte.furniture.num_of_component
    furniture_market_rate furniture_manufacte.furniture.market_rate
