...
# data handling
dirty_table = CSV.File("works_on_dirty.csv") |> DataFrame
clean_table = CSV.File(replace("works_on_dirty.csv", "dirty.csv" => "clean.csv")) |> DataFrame
...
## construct possibilities
cols = Any[Any[-1, "*"], Any[0, "employee ssn"], Any[0, "project number"], Any[0, "hours"], Any[1, "first name"], Any[1, "minit"], Any[1, "last name"], Any[1, "ssn"], Any[1, "birth date"], Any[1, "address"], Any[1, "sex"], Any[1, "salary"], Any[1, "super ssn"], Any[1, "department no"], Any[2, "department name"], Any[2, "department number"], Any[2, "manager ssn"], Any[2, "manager start date"], Any[3, "dependent name"], Any[3, "dependent number"], Any[3, "dependent location"], Any[3, "department number"], Any[4, "employee ssn"], Any[4, "dependent name"], Any[4, "sex"], Any[4, "birth date"], Any[4, "relationship"], Any[5, "department number"], Any[5, "department location"]]
