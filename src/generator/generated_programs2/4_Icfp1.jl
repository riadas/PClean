...
## construct possibilities
cols = Any[Any[-1, "*"], Any[0, "institution id"], Any[0, "name"], Any[0, "country"], Any[1, "author id"], Any[1, "last name"], Any[1, "first name"], Any[2, "paper id"], Any[2, "title"], Any[3, "author id"], Any[3, "institution id"], Any[3, "paper id"], Any[3, "author count"]]
foreign_keys = map(tup -> cols[tup[1] + 1], Any[Any[11, 7], Any[10, 1], Any[9, 4]])
